...
const Hero = () => {
  ...
  const slides = [
    {
      title: t("hero.autumnSale"),
      subtitle: t("hero.womens"),
      preTitle: t("hero.newTrend"),
      buttonText: t("hero.shopNow"),
      image: image,
    },
    {
      title: t("hero.winterCollection"),
      subtitle: t("hero.exclusive"),
      preTitle: t("hero.limitedEdition"),
      buttonText: t("hero.discoverMore"),
      image: image,
    },
    {
      title: t("hero.specialOffers"),
      subtitle: t("hero.discount"),
      preTitle: t("hero.thisWeekOnly"),
      buttonText: t("hero.getItNow"),
      image: image,
    },
  ];
  return (
